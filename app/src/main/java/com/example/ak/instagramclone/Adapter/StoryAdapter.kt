...
import com.example.ak.instagramclone.AddStoryActivity

import com.example.ak.instagramclone.Model.Story
import com.example.ak.instagramclone.Model.User
import com.example.ak.instagramclone.R
import com.example.ak.instagramclone.StoryActivity
  ...
  RecyclerView.Adapter<StoryAdapter.ViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        UserInformation(holder, story.getUserId(), position)
    ...
    private fun UserInformation(viewHolder: ViewHolder, userId: String, position: Int)
    {
