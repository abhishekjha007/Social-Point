            ...
            else ->
            {
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if(task.isSuccessful)
                    {
                        ...
                        val timeEnd = System.currentTimeMillis() + 86400000 //Add our Story for one Day(24 hours)..
                        ...
                        Toast.makeText(this, "Your Story has been Uploaded Successfully..", Toast.LENGTH_LONG).show()
