...
import com.example.ak.instagramclone.Model.Notification
...

{
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int)
    {
        ...
        UserInformation(holder.profileImage, holder.userName, notification.getUserId())
        ...
        if(notification.isIsPost())
        {
            ...
            GetPostImageFromTheUserInCommentsActivity(holder.postImage, notification.getPostId())
        }
        else
        {
    ...
    private fun UserInformation(imageView: ImageView, userName: TextView, publisherId: String)
    {
    ...
    private fun GetPostImageFromTheUserInCommentsActivity(imageView: ImageView, postID: String)
    {
