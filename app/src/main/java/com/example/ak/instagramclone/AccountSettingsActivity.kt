...
class AccountSettingsActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?)
    {
        ...
        save_infor_profile_btn.setOnClickListener {
           if(checker == "clicked")
           {
               UpdateUserImageAndUpdateUserInformation()
           }
           else
           {
               UpdateUserInformationOnly()
           }
        }
    ...
    private fun UpdateUserInformationOnly()
    {
        when {
            full_name_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Fullname first", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Username first", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Bio first", Toast.LENGTH_LONG).show()
            else -> {
    ...
    private fun UpdateUserImageAndUpdateUserInformation()
    {

        when
        {
            imageUri == null -> Toast.makeText(this, "Please upload your Image first", Toast.LENGTH_LONG).show()
            full_name_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Fullname first", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Username first", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "Please update Bio first", Toast.LENGTH_LONG).show()
