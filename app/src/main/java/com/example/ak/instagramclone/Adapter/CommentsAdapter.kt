...

{
    ...
    override fun onBindViewHolder(holder: CommentAdapter.ViewHolder, position: Int)
    {
        ...
        GetUserInformationImageAndUsername(holder.imageProfile, holder.userNameTV, comment.getPublisher())
    }
    ...
    private fun GetUserInformationImageAndUsername(imageProfile: CircleImageView, userNameTV: TextView, publisher: String)
    {
